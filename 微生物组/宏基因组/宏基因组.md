...
# 3 批量操作    
cd /ifs1/VipData/17.meta/data/PRJEB30781
...
kneaddata  -i /ifs1/VipData/17.meta/data/PRJEB36155/illumina/ERR4007992_1.fastq.gz \
    -i /ifs1/VipData/17.meta/data/PRJEB36155/illumina/ERR4007992_2.fastq.gz \
    -db /ifs1/MetaDatabase/kneadData_databases/human_genome_bowtie2/Homo_sapiens \
...
# 1  质控过滤过滤  
mkdir qc
fastqc -f fastq -o qc /ifs1/VipData/17.meta/data/hmp/SRS011243/*.fastq.gz -t 12

fastp -i /ifs1/VipData/17.meta/data/hmp/SRS011243/SRS011243.1.fastq.gz -o SRS011243_clean.1.fq.gz \
    -I /ifs1/VipData/17.meta/data/hmp/SRS011243/SRS011243.2.fastq.gz -O SRS011243_clean.2.fq.gz \
    -D -z 4 -q 20 -u 30 -n 10 -h SRS011243.html

#3 bwa+samtools去重复
REF=/ifs1/VipData/04.ncov/database/human_g1k_v37_bwamem2/human_g1k_v37.fasta
READ1=/ifs1/VipData/17.meta/data/hmp/SRS011243/SRS011243.1.fastq.gz
READ2=/ifs1/VipData/17.meta/data/hmp/SRS011243/SRS011243.2.fastq.gz

bwa-mem2 mem $REF $READ1 $READ2 -o SRS011243.sam -t 12
/ifs1/Software/bin/samtools flagstat -@ 12 SRS011243.sam 
#过滤掉比对上的
/ifs1/Software/bin/samtools fastq -@ 12 -G 2 -1 SRS011243_filter.1.fastq -2 SRS011243_filter.2.fastq SRS011243.sam  
#压缩
...
cat metadata.txt | awk '{if (NR > 1) print $1}' | while read i;do echo "metaphlan --input_type fastq --nproc 12 \
    /ifs1/VipData/17.meta/data/hmp/${i}/${i}.1.fastq.gz,/ifs1/VipData/17.meta/data/hmp/${i}/${i}.2.fastq.gz \

...
#if($samn>=3){
#	print  "$python $Bin/flower.py --stat $outdir/flower_OTU_stat.xls --outdir $outdir --prefix ${name}_flower_plot\n";
#	system( "$python $Bin/flower.py --stat $outdir/flower_OTU_stat.xls --outdir $outdir --prefix ${name}_flower_plot");
#}
